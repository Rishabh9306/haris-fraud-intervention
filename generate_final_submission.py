"""
generate_final_submission.py — Generates FINAL_SUBMISSION.docx from the official template.
Updates:
- Team name: DND
- Team size: 2
- Contact email: gupta.rishabh0406@gmail.com
- Based in: Mumbai, India
- Embeds verified YouTube walkthrough link
- Enforces strict typography, zero residual paragraphs, zero space errors.
"""
...
OUT = r'C:\Users\Admin\Documents\antigravity\charming-galileo\haris\FINAL_SUBMISSION.docx'
...
BOX_A = [
    ...
    "Team size / based in: 2 / Mumbai, India",
...
BOX_P = [
    ...
    'Engineering Partner | Backend & Telephony Systems Architecture | Built: Scalable API gateways & real-time webhook infrastructure'
]
...
for idx, lines in SECTIONS.items():
    ...
    # 1. Clean out existing paragraphs completely
...
doc.save(OUT)
print(f"Pristine FINAL_SUBMISSION.docx generated successfully at: {OUT}")
